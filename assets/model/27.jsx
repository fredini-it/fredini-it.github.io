...
Command: npx gltfjsx@6.5.3 C:\cmd\redux\reduxblender\27.glb -o C:\cmd\redux\reduxblender\27.jsx --shadows --keepnames --meta --printwidth 120 --precision 3 --transform --resolution 1024 --keepmeshes --keepmaterials --format webp 
Files: C:\cmd\redux\reduxblender\27.glb [7.63MB] > C:\cmd\redux\reduxblender\27-transformed.glb [1.42MB] (81%)
*/
...
export function 27(props) {
  const { nodes, materials } = useGLTF('/27-transformed.glb')
  return (
